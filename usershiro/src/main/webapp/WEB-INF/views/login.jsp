...
<%@ page import="cn.sto.manage.utils.CaptchaException"%>
...
<body>
		...
		<div style="float:left;width:100%;">
			<div class="login_main">
				...
				<div class="login_main_ln">
					<input type="text" id="username" name="loginName" value="admin"/>
				</div>
	...
	<c:choose>
		<c:when test="${error eq 'cn.sto.manage.utils.CaptchaException'}">
			<script>
